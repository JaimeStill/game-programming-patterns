...
call yarn add -D @angular-devkit/build-angular @angular/cli @angular/compiler-cli @angular/language-service @fortawesome/fontawesome-free @types/node material-icons minimist roboto-fontface ts-node tslint typescript
