...
The effort pays off if you guess right and end up touching that code later. But predicting the future is *hard*, and when that modularity doesn't end up being helpful, it quickly becomes actively harmful. After all, it is more code you have to deal with.
...
[Next - Design Patterns Revisited](./2.design-patterns-revisited.md)  

[Previous - Introduction](./readme.md#introduction)  